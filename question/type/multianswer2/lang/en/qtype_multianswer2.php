...
/**
 * Strings for component 'qtype_multianswer2', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['noquestions'] = 'The Cloze(multianswer2) question "<strong>{$a}</strong>" does not contain any question';
$string['pleaseananswerallparts'] = 'Please answer all parts of the question.';
$string['pluginname'] = 'Embedded answers (Cloze) 2';
$string['pluginname_help'] = 'Embedded answers (Cloze) 2 questions consist of a passage of text with questions such as multiple-choice and short answer embedded within it.';
$string['pluginname_link'] = 'question/type/multianswer2';
$string['pluginnameadding'] = 'Adding an Embedded answers (Cloze) 2 question';
$string['pluginnameediting'] = 'Editing an Embedded answers (Cloze) 2 question';
...
$string['questionsless'] = '{$a} question(s) less than in the multianswer2 question stored in the database';
$string['questionsmissing'] = 'The question text must include at least one embedded answer.';
$string['questionsmore'] = '{$a} question(s) more than in the multianswer2 question stored in the database';
